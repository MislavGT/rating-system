...
import static hr.pmf.project.rating.Event.GAMMA;
import static hr.pmf.project.rating.Event.RHO;
import static hr.pmf.project.rating.Event.hyp;
...
public class CalculationDiffuse implements Callable<Void>{
    ...
    public Void call() throws Exception {
        ...
        priors.add(new Triplet(hyp(player.getSigma(), BETA),
                player.getMean(),
                element.getValue1()));
